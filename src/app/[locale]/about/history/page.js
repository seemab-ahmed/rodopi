...
const HistoryPage = () => {
  ...
  const certificates = [
    ...
    },
    {
      ...
      description:
        'Quality management certification for whg rodopi marine services',
    },
    {
      id: 9,
      title: 'ISO 9001 Wind Services',
      ...
      description:
        'Quality management certification for whg rodopi wind services',
    },
  ];
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto'>
            ...
            <section className='w-full py-4 sm:pt-10 bg-white'>
              <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <Image
                  src='/images/RODOPI Success Map_2.png'
                  alt='Team Image'
                  width={1200}
                  height={800}
                  className='w-full h-auto object-cover'
