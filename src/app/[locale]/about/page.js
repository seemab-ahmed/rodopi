...
const AboutPage = () => {
    ...
    const [counts, setCounts] = useState([1000, 15, 500])
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8">
                            {values.map((value, idx) => (
                                <div key={idx} className="group text-center">
                                    <div className="bg-gradient-to-br from-gray-50 h-[210px] to-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-primary/20">
