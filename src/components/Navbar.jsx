      ...
      {open && (
        <div className="absolute top-full right-0 mt-1 w-20 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
          {languages.map((lang) => (
            <button
              key={lang.code}
              className={`flex items-center space-x-2 w-full px-3 py-1 text-sm text-left hover:bg-gray-50 transition-colors ${
  ...
  const menuItems = [
    { key: "home", href: `/${currentLocale}`, hasDropdown: false },
    {
      ...
      submenu: [
        {
          key: "wind_energy",
          href: `/${currentLocale}/industries/wind_energy`,
        },
        {
          key: "solar_energy",
        ...
        },
        {
          ...
          href: `/${currentLocale}/industries/infrastructure_services`,
        },
        {
    ...
    },
    {
      ...
      submenu: [
        {
          key: "wind_maintenance",
          href: `/${currentLocale}/services/wind_maintenance`,
        },
        {
          key: "solar_projects",
          href: `/${currentLocale}/services/solar_projects`,
        },
        {
          key: "skilled_teams",
        ...
        {
          key: "corrosion_protection",
          href: `/${currentLocale}/services/corrosion_protection`,
        },
        {
          key: "onsite_corrosion",
          href: `/${currentLocale}/services/onsite_corrosion`,
        },
        {
          key: "workwear_safety",
          href: `/${currentLocale}/services/workwear_safety`,
        },
      ],
    },
    { 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-10 text-sm text-gray-600">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/company/rodopi/"
                target="_blank"
              ...
              {/* YouTube */}
              <a
                href="https://www.youtube.com/@rodopi3290"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
              >
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/rodopigmbh/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
              >
          ...
          >
            {menuItems.map((item) => (
              <div key={item.key} className="relative group">
                <button
                  className={`flex items-center space-x-1 px-3 py-2 text-sm font-medium transition-colors cursor-pointer ${
                    isActive(item.href)
                ...
                {item.hasDropdown && (
                  <div
                    className={`absolute top-full left-0 mt-1 w-80 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 ${
